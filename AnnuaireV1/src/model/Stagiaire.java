...
public class Stagiaire {
    ...
    public Boolean compareMultiCrit(Stagiaire stagiaireAComparer) {
    	Boolean b = true;
    	if ((stagiaireAComparer.nom!=null) && (!this.nom.equals(stagiaireAComparer.nom))) {
    		b = false;
    	}
    	if ((stagiaireAComparer.prenom!=null) && (!this.prenom.equals(stagiaireAComparer.prenom))) {
    		b = false;
    	}
    	if ((stagiaireAComparer.departement!=null) && (!this.departement.equals(stagiaireAComparer.departement))) {
    		b = false;
    	}
    	if ((stagiaireAComparer.promo!=null) && (!this.promo.equals(stagiaireAComparer.promo))) {
    		b = false;
    	}
